...
Test Robot Version Quatre
    [Documentation]
    ...     On utilise le mot-clef   Recherche Effective Github  sans spécifier d'arguments
    ...     Normalement la requete est gérée avec la structure de condition    IF END
    navigation.Revenir A La Page D Acceuil GitHub
    navigation.Recherche Effective Github
    Log To Console  \n${TAG_INFO} Execution du KW qui contient la nouvelle syntaxe V4 .
