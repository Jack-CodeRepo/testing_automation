...
Library             %{ROBOT_PATH}${/}3_2_2${/}python_kw${/}myPythonKW.py
Library             %{ROBOT_PATH}${/}3_2_2${/}python_kw${/}myPythonKWfunc.py
...
Autre Calcul
    ...
    Run Keyword If  ${resultat}>0       Log To Console  \n${TAG_INFO} Le resultat est ${resultat} // Appel: ${string}  stream=STDOUT  no_newline=False
